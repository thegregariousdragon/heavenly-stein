...
3. `CANON_INDEX.md`
4. `quick-reference/CANON_LOCKS.md`
5. `quick-reference/STATION_BLOCKING_GUIDE.md`
6. `quick-reference/CHARACTER_QUICK_CARDS.md`
...
- The station layout is easiest to navigate through `quick-reference/STATION_BLOCKING_GUIDE.md`.
- Character lookup is fastest through `quick-reference/CHARACTER_QUICK_CARDS.md` and `quick-reference/SHORTHAND_DECODER.md`.
